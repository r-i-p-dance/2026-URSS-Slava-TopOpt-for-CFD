...
High Mach Numbers: The BGK approximation only holds tightly when the fluid is relatively close to equilibrium (incompressible, low Mach number flows). If you try to simulate supersonic shockwaves, the basic BGK model falls apart and explodes into numerical instability.
